...
const provider = new AlchemyProvider('homestead', 'ep6XqV8bdsg6M4UPa7phx7poMlXTL9pk')
...
t('resolves ENS name', async () => {
  assert.equal(await resolveAddress({ addr: 'v1rtl.eth', provider }), '0xD3B282e9880cDcB1142830731cD83f7ac0e1043f')
})
