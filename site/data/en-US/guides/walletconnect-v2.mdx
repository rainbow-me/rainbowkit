...
If your dApp requires supporting a legacy wallet that has not yet migrated to WalletConnect v2, RainbowKit's default WalletConnect version can be overridden for each wallet independently.
