...
Pass an instance of the `rainbowConnector` to `createConfig` with projectId and appName, and wrap your app in the `RainbowButtonProvider`. Then drop-in the `RainbowButton` component.
