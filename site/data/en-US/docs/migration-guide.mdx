...
We've introduced a new way of adding a custom chain. You can either use `getDefaultConfig` which is recommended or `createConfig` from wagmi, but use strict types if you use TypeScript in your project.
