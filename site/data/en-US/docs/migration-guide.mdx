...
If you use custom wallets you no longer need to pass in `projectId`, `chains` or even walletConnect parameters individually. We've also updated `connectorsForWallets` and `getDefaultWallets`.
