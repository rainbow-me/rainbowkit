...
The RainbowKit API itself remains unchanged. Your existing configuration with `getDefaultConfig`, `<RainbowKitProvider>`, and custom wallet lists will continue to work without modification.

[You can read an in-depth migration guide here](https://rainbowkit.com/guides/rainbowkit-wagmi-v3).
