...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: "object",
      description: "Function for converting a mobile wallet connection URI",
    },
    {
      name: "desktop",
      required: false,
      type: "{ getUri?: (uri: string) => string }",
      typeSimple: "object",
      description: "Function for converting a desktop app deep link",
    },
    {
      name: "qrCode",
      required: false,
      ...
      typeSimple: "object",
      description:
        "Object containing a function for converting the QR code URI, plus optional mobile wallet setup instructions",
    },
    {
      name: "extension",
      required: false,
    ...
    },
    {
      ...
      required: true,
      type: "createConnector: (options: WalletOptionsParams) => CreateConnectorFn",
      typeSimple: "(options: WalletOptionsParams) => CreateConnectorFn",
      description:
        "Function for providing the connector instance",
    },
  ]}
/>
