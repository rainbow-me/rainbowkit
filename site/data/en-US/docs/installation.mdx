...
Install RainbowKit and its peer dependencies, [Wagmi v2](https://wagmi.sh/) and [Viem](https://viem.sh).
...
[Read more about configuring chains & config with `wagmi v2`](https://wagmi.sh/core/getting-started#create-config).

#### Wrap providers

Wrap your application with `RainbowKitProvider` and [`WagmiProvider`](https://wagmi.sh/react/api/WagmiProvider#wagmiprovider).
