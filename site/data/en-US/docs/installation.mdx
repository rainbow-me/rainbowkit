...
Install RainbowKit and its peer dependencies, [wagmi v2](https://rc.wagmi.sh/) and [viem](https://viem.sh).

```bash
npm install @rainbow-me/rainbowkit@beta wagmi@rc viem@2.
```
...
[Read more about configuring chains & config with `wagmi v2`](https://rc.wagmi.sh/core/getting-started#create-config).

#### Wrap providers

Wrap your application with `RainbowKitProvider` and [`WagmiProvider`](https://rc.wagmi.sh/react/api/WagmiProvider#wagmiprovider).
