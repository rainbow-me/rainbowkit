...
Some chains might give you errors or warnings when you try to add them to your wallet. For these, use our built-in chains. We don't have them for all chains, just for the ones that often cause problems.
