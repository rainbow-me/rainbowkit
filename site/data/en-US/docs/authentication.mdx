...
Install the `@rainbow-me/rainbowkit-siwe-next-auth@beta` package and its peer dependency, [ethers](https://docs.ethers.org/v5/).

```bash
npm install @rainbow-me/rainbowkit-siwe-next-auth@beta siwe@^2 ethers@^5
```
