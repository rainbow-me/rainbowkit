...
EIP-6963 makes it easier for apps on Ethereum (called dapps) to find and connect with all the wallets you have in your browser. If this gets used, it'll make using these apps simpler and give you more control over your wallets. RainbowKit supports it for you out of the box!
