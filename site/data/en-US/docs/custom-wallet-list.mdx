...
#### Wallets with Required Configuration

Some wallets like Gemini require configuration parameters. Here's how to use them:
...
// Configure wallets that require parameters
const gemini = geminiWallet({
  appName: 'My App',
  appIcon: 'https://my-app.com/logo.png', // Optional
});
  ...
  [
    {
      ...
      wallets: [
        rainbowWallet,
        gemini, // Use the configured instance
        walletConnectWallet,
      ],
    },
  ],
