...
Passez une instance de `RainbowConnector` à votre liste de connecteurs de Wagmi et enveloppez votre application dans `RainbowButtonProvider`. Ensuite, insérez le composant `RainbowButton` dans votre liste de portefeuilles.
