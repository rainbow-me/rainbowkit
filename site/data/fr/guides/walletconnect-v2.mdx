...
Si votre dApp nécessite le support d'un portefeuille legacy qui n'a pas encore migré vers WalletConnect v2, la version par défaut de WalletConnect de RainbowKit peut être remplacée pour chaque portefeuille indépendamment.
