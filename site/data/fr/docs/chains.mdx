...
RainbowKit est conçu pour s'intégrer avec [l'objet `chain` de wagmi](https://wagmi.sh/react/chains). Consultez la liste des chaînes prises en charge [ici](https://wagmi.sh/react/chains#supported-chains).
...
### Métadonnées des chaînes personnalisées
