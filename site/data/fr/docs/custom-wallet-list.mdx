...
Un argument `préférence` est disponible pour contrôler si Smart Wallet est préféré ou désactivé pour vos utilisateurs. Le comportement basé sur les préférences est documenté [ici](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

Des options de configuration supplémentaires pour le contrôle des [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) et des [Sous-comptes](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) sont disponibles dans les documents SDK de Coinbase Wallet [ici](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
...
Afficher Rainbow, MetaMask et Coinbase avec des portefeuilles génériques de secours.
...
Recommandez Rainbow et MetaMask, mais proposez également Coinbase avec des portefeuilles génériques de secours.
