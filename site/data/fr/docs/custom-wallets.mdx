...
> Note: Cette API est instable et susceptible de changer dans un avenir proche. Nous ajouterons plus de portefeuilles intégrés avec le temps. [Faites-nous savoir](https://github.com/rainbow-me/rainbowkit/issues) s'il y a des portefeuilles particuliers qui vous intéressent.
...
### Propriétés de RainbowKitConnector

Les propriétés suivantes sont définies sur la valeur de retour de la fonction `createConnector`.
