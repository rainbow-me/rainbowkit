...
<TableauDesProps
  data={[
    ...
    },
    {
      ...
      required: false,
      default: 'complet',
      type: '"avatar" | "adresse" | "complet" | { petitÉcran: StatutCompte, grandÉcran?: StatutCompte }',
      typeSimple: 'enum',
      description:
    ...
    },
    {
      name: 'chainStatus',
      required: false,
      default: '{ petitÉcran: "icône", grandÉcran: "complet" }',
      type: '"icône" | "nom" | "complet" | "aucun" | { petitÉcran: StatutChaîne, grandÉcran?: StatutChaîne }',
      typeSimple: 'enum',
      description:
    ...
    },
    {
      name: 'showBalance',
      required: false,
      default: '{ petitÉcran: false, grandÉcran: true }',
      type: 'boolean | { petitÉcran: boolean, grandÉcran?: boolean }',
      typeSimple: 'enum',
      description:
