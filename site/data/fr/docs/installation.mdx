...
RainbowKit fonctionne avec à la fois [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (le bundler par défaut dans Next.js 16+) et [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).

Si vous utilisez des plugins qui nécessitent encore Webpack, ajoutez le drapeau `--webpack` à vos scripts :
