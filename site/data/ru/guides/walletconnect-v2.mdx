...
Если ваше dApp требует поддержки устаревшего кошелька, который еще не перешел на WalletConnect v2, стандартную версию WalletConnect в RainbowKit можно переопределить для каждого кошелька независимо.
