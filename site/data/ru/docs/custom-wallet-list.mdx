...
Доступен аргумент `preference` для управления тем, включен ли Smart Wallet и доступен ли он для пользователей. Поведение на основе предпочтений документировано [здесь](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

Дополнительные параметры конфигурации для управления [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) и [Sub Accounts](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) можно найти в документации SDK для кошелька Coinbase, [здесь](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
