...
Вы можете настроить пользовательский интерфейс RainbowKit, чтобы он соответствовал вашему бренду. Вы можете выбрать из нескольких предустановленных акцентных цветов и конфигураций радиуса границы.
