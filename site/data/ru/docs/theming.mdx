...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description:
        "The font stack used throughout the UI. Обратите внимание, что `rounded` пытается использовать SF Pro Rounded, и при отсутствии его будет использована системная шрифтовая схема.",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'Размытие фона модального окна.',
    },
  ]}
/>
