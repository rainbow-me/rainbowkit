...
RainbowKit работает как с [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (по умолчанию сборщик в Next.js 16+), так и с [Webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).
