...
Se o seu dApp requer suporte a uma carteira legada que ainda não migrou para WalletConnect v2, a versão padrão WalletConnect do RainbowKit pode ser substituída para cada carteira independentemente.
...
Uma vez que os servidores WalletConnect v1 forem desligados no dia 28 de junho, um [servidor bridge personalizado](https://docs.walletconnect.com/1.0/bridge-server) é necessário para continuar usando o protocolo v1. Consulte os exemplos a seguir:
