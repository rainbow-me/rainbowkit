...
Um argumento de `preferência` está disponível para controlar se a Smart Wallet está ativada e disponível para os usuários. O comportamento baseado em preferência está documentado [aqui](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

Opções adicionais de configuração para controle de [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) e [Sub Accounts](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) podem ser encontradas na documentação do Coinbase Wallet SDK [aqui](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
