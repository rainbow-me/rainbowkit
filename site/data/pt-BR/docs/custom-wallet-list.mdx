...
Este conector de carteira suporta tanto o aplicativo e extensão Coinbase Wallet quanto o Coinbase Smart Wallet na Web.

Um argumento `preference` está disponível para controlar se o Smart Wallet é preferido ou desativado para seus usuários. O comportamento baseado em preferência está documentado [aqui](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

Opções de configuração adicionais para controle de [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) e [Contas Subsidiárias](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) podem ser encontradas nos documentos SDK da Coinbase Wallet [aqui](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
...
Mostre Rainbow, MetaMask e Coinbase junto com carteiras genéricas de fallback.
...
Recomende Rainbow e MetaMask, mas também ofereça Coinbase junto com carteiras genéricas de fallback.
