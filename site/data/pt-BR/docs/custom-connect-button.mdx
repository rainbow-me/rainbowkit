...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'boolean',
      description:
        'Booleano que indica se a conta possui transações pendentes para a rede atual',
    },
  ]}
/>
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Booleano que indica se a cadeia atual não é suportada',
    },
  ]}
/>
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: '() => void',
      description: 'Função para abrir o modal da rede',
    },
    {
    ...
    },
    {
      ...
      required: false,
      type: 'boolean',
      description: 'Booleano indicando se o modal da rede está aberto',
    },
    {
