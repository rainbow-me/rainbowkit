...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'URL para ícone de carteira, ou uma promessa que resolve para um URL de dados Base64',
    },
    {
      name: 'iconAccent',
      required: false,
    ...
    },
    {
      ...
      required: true,
      type: 'string',
      description: 'Cor de fundo enquanto o ícone da carteira é carregado',
    },
    {
      name: 'installed',
      required: false,
      ...
      description: (
        <>
          ...
          <code>indefinido</code> se indeterminado
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      description:
        'Função para calcular se esta carteira deve ser ocultada da lista. Isso é útil para definir carteiras genéricas de fallback, por exemplo, o fallback integrado "Injected Wallet" faz uso desse recurso',
    },
    {
...
### Propriedades do RainbowKitConnector

As seguintes propriedades são definidas no valor de retorno da função `createConnector`.
