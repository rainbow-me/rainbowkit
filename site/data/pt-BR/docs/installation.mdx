...
O RainbowKit funciona tanto com [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (o empacotador padrão no Next.js 16+) quanto com [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).

Se você está usando plugins que ainda requerem o Webpack, adicione a opção `--webpack` aos seus scripts:
