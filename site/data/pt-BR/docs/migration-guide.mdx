...
Consulte nossa [Configuração do Next.js](https://github.com/rainbow-me/rainbowkit/blob/main/examples/with-next/next.config.js) como exemplo para orientações de configuração para seu projeto.
