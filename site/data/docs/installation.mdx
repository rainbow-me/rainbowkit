...
[Configure your desired chains](https://wagmi.sh/docs/providers/configuring-chains) and generate the required connectors. You will also need to [setup a `wagmi` client](https://wagmi.sh/docs/WagmiConfig#client-optional).
