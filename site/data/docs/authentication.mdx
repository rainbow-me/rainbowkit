...
While it's possible to integrate with [third-party and custom Authentication Providers](/docs/custom-authentication), RainbowKit provides first-class support for [Sign-In with Ethereum](https://login.xyz) and [NextAuth.js.](https://next-auth.js.org)
