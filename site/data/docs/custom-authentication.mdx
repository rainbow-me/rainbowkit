...
While RainbowKit provides [first-class support for Sign-In with Ethereum and NextAuth.js,](/docs/authentication#set-up-sign-in-with-ethereum-and-nextauthjs) you can also integrate with third-party and custom Authentication Providers.

### Third-party Authentication Providers

For instructions on how to install and use these adapters, please refer to their documentation.

- [UseSIWE Adapter](https://github.com/random-bits-studio/rainbowkit-use-siwe-auth) - A RainbowKit authentication adapter for [UseSIWE](https://github.com/random-bits-studio/use-siwe). The easiest way to add Sign-in with Ethereum to your app.
