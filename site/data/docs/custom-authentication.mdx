...
As an example, we could make an authentication adapter for using [Sign-In with Ethereum](https://login.xyz) against some [custom API endpoints.](https://wagmi.sh/examples/sign-in-with-ethereum)
...
export default function App({ Component, pageProps }: AppProps) {
  ...
  // using on your application's authentication system.
