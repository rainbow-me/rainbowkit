...
You can provide your own disclaimer. The (`disclaimer`) prop takes a function with args `Text` and `Link` that you can use to build your own disclaimer that inherits the theming system:
