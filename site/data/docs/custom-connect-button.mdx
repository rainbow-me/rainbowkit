...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'boolean',
      description:
        'Boolean indicating whether the component is ready to render to the user',
    },
    {
      name: 'connectionStatus',
      required: false,
      type: '"loading" | "disconnected" | "unauthenticated" | "connected"',
      description:
        'The status of the connection, including an additional "unauthenticated" status if authentication is required but has not been completed by the user',
    },
    {
