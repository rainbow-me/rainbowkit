...
const wallets: Wallets = [
  {
    ...
    wallets: [
      wallet.rainbow({ chains, apiConfig: { alchemyId } }),
      wallet.walletConnect({ chains, apiConfig: { alchemyId } }),
    ],
  },
];
```
...
const wallets: WalletList = [
  {
    groupName: 'Recommended',
    wallets: [
      wallet.metaMask({ chains, apiConfig: { alchemyId } }),
      wallet.walletConnect({ chains, apiConfig: { alchemyId } }),
    ],
  },
];
...
const wallets: Wallets = [
  {
    ...
    wallets: [
      ...
      ...(needsInjectedWalletFallback
        ? [wallet.injected({ chains, apiConfig: { alchemyId } })]
        : []),
    ],
  },
];
