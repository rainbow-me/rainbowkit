  ...
  data={[
    {
      ...
      required: false,
      default: 'blue',
      type: '"blue" | "green" | "orange" | "pink" | "purple" | "red" | { color: string, foregroundTextColor: string }',
      typeSimple: 'enum',
      description:
        'The background/text color of various interactive elements. Accepts either a built-in preset color, or a custom value defined as an object with `color` and `foregroundTextColor` properties.',
    },
    {
      name: 'borderRadius',
      required: false,
