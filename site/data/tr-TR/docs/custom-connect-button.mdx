...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: (
        <>
          Zincir ismi, ör. <code>"Ethereum"</code>
        </>
      ),
    },
    {
      ...
      description:
        'Geçerli zincirin desteklenmediğini belirten Boolean',
    },
  ]}
/>
  ...
  data={[
    {
      ...
      required: false,
      type: '() => void',
      description: 'Hesap modalını açmak için fonksiyon',
    },
    {
      name: 'openChainModal',
      required: false,
      type: '() => void',
      description: 'Zincir modalını açmak için fonksiyon',
    },
    {
      name: 'openConnectModal',
      required: false,
      type: '() => void',
      description: 'Bağlan modalını açmak için fonksiyon',
    },
    {
      ...
      type: 'boolean',
      description:
        'Hesap modalının açık olup olmadığını belirten boolean.',
    },
    {
      name: 'chainModalOpen',
      required: false,
      type: 'boolean',
      description: 'Zincir modalının açık olup olmadığını belirten boolean.',
    },
    {
      ...
      type: 'boolean',
      description:
        'Bağlan modalının açık olup olmadığını belirten boolean.',
    },
  ]}
/>
