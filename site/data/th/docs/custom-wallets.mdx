...
> หมายเหตุ: API นี้ไม่เสถียรและข้อกำหนดอาจมีการเปลี่ยนแปลงในอนาคตใกล้ เราจะเพิ่มกระเป๋าเงินที่สร้างมาแล้วในอนาคต [แจ้งให้เรารู้](https://github.com/rainbow-me/rainbowkit/issues) หากมีกระเป๋าเงินเฉพาะที่คุณสนใจ
