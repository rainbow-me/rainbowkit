...
> หมายเหตุ: API นี้ไม่เสถียรและมีความเป็นไปได้ที่จะเปลี่ยนแปลงในอนาคตใกล้ เราจะเพิ่มกระเป๋าเงินที่สร้างมาแล้วในอนาคต [แจ้งให้เรารู้](https://github.com/rainbow-me/rainbowkit/issues) หากมีกระเป๋าเงินเฉพาะที่คุณสนใจ
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Function for calculating whether this wallet should be hidden from the list. นี่เป็นประโยชน์สำหรับการกำหนดตัวแทนที่หลุดสำหรับกระเป๋าเงินทั่วไป เช่น คุณลักษณะหลุด "Injected Wallet" ซึ่งใช้คุณลักษณะนี้',
    },
    {
      ...
      description:
        'ฟังก์ชันสำหรับการให้ตัวแทนเชื่อมต่อและการกำหนดค่าสำหรับวิธีเชื่อมต่อต่างๆ ที่อธิบายด้านล่าง',
    },
  ]}
/>
...
### คุณสมบัติของ RainbowKitConnector

คุณสมบัติต่อไปนี้ถูกกำหนดขึ้นบนค่าที่ส่งคืนของฟังก์ชัน `createConnector`.
