...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description:
        "The font stack used throughout the UI. โปรดทราบว่า `rounded` พยายามใช้ SF Pro Rounded และเปลี่ยนไปใช้ระบบฟอนต์เมื่อไม่สามารถใช้งานได้.",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'ความพลางพื้นหลังของโมดอล',
    },
  ]}
/>
...
แต่ละธีมยังให้คำประกอบสีเฉพาะ (`blue`, `green`, `orange`, `pink`, `purple`, `red`) ที่สามารถแพร่ไปในวัตถุตัวเลือก ตัวอย่างเช่น การใช้คำประกอบสี `pink`:
