...
ตัวเชื่อมกระเป๋าเงินนี้สนับสนุนแอปและโปรแกรมเสริมของ Coinbase Wallet รวมถึง Coinbase Smart Wallet บนเว็บไซต์.

มี argument `preference` เพื่อควบคุมว่าจะให้ Smart Wallet เป็นที่ต้องการหรือปิดใช้งานสำหรับผู้ใช้ของคุณ พฤติกรรมตาม preference ถูกเอกสารไว้ [ที่นี่](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

ตัวเลือกการกำหนดค่าเพิ่มเติมเพื่อควบคุม [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) และ [Sub Accounts](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) สามารถพบในเอกสาร SDK ของ Coinbase Wallet [ที่นี่](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
...
แสดง Rainbow, MetaMask และ Coinbase พร้อมกับกระเป๋าเงินสำรองทั่วไป.
...
แนะนำ Rainbow และ MetaMask แต่ยังเสนอ Coinbase พร้อมกับกระเป๋าเงินสำรองทั่วไปด้วย.
