...
RainbowKit ทำงานได้กับทั้ง [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (การรวมค่าเริ่มต้นใน Next.js 16+) และ [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).
