...
การสนับสนุน WalletConnect v2 ตอนนี้เป็นมาตรฐานใน RainbowKit โดยไม่มีการเปลี่ยนแปลงที่จะทำให้เกิดความเสียหาย เพียงทำการอัปเกรดและอ้างอิงถึงคู่มือด้านล่างสำหรับรายละเอียดเพิ่มเติม
...
ทุก ๆ dApp ที่ใช้ WalletConnect ตอนนี้จำเป็นต้องรับ `projectId` จาก [WalletConnect Cloud](https://cloud.walletconnect.com/). สิ่งนี้ฟรีและใช้เวลาเพียงไม่กี่นาที.
...
ถ้า dApp ของคุณต้องการสนับสนุนกระเป๋าเงินรุ่นเก่าที่ยังไม่ได้ย้ายไปที่ WalletConnect v2, RainbowKit's มีทางเลือกในการใช้ WalletConnect ได้แบบเป็นแค่ที่เดียว
...
เมื่อเซิร์ฟเวอร์ WalletConnect v1 ถูกปิดการทำงานในวันที่ 28 มิถุนายน, ต้องมี [เซิร์ฟเวอร์สำหรับการเชื่อมต่อที่กำหนดเอง](https://docs.walletconnect.com/1.0/bridge-server) เพื่อทำการใช้งานโปรโตคอล v1 ต่อไป. อ้างอิงตัวอย่างต่อไปนี้:
