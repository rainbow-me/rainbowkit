...
หาก dApp ของคุณต้องการให้รองรับกระเป๋าเงินเวอร์ชันเก่าที่ยังไม่ได้ย้ายไปใช้ WalletConnect v2, RainbowKit สามารถตั้งค่าเปลี่ยนเวอร์ชัน WalletConnect มาตรฐานได้สำหรับแต่ละกระเป๋าเงินได้อย่างอิสระ
