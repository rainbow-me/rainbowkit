...
Jika dApp Anda membutuhkan dukungan dompet lama yang belum bermigrasi ke WalletConnect v2, versi WalletConnect default RainbowKit dapat diganti untuk masing-masing dompet secara independen.
