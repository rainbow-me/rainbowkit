...
RainbowKit dirancang untuk berintegrasi dengan [objek `chain` dari wagmi](https://wagmi.sh/react/chains). Lihat daftar rantai yang didukung [di sini](https://wagmi.sh/react/chains#supported-chains).
