  ...
  data={[
    {
      ...
      type: 'string',
      description:
        'Warna latar/depan dari berbagai elemen interaktif.',
    },
    {
      ...
      type: 'string',
      description:
        'Warna yang digunakan untuk elemen latar depan yang dirender di atas warna aksen.',
    },
    {
      name: 'borderRadius',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'Ukuran dari seluruh skala radius border.',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      typeSimple: 'enum',
      description:
        "Tumpukan font yang digunakan di seluruh UI. Perhatikan bahwa `rounded` mencoba menggunakan SF Pro Rounded, dan beralih ke font sistem ketika tidak tersedia.",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'Kabur latar belakang modal.',
    },
  ]}
/>
