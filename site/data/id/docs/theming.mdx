...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description:
        "Tumpukan font yang digunakan di seluruh UI. Perhatikan bahwa `bulat` mencoba menggunakan SF Pro Rounded, beralih ke font sistem ketika tidak tersedia.",
    },
    {
      name: 'overlayBlur',
      required: false,
      default: 'tidak',
      type: '"besar" | "kecil" | "tidak"',
      typeSimple: 'enum',
