...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description:
        "The font stack used throughout the UI. Perhatikan bahwa `rounded` mencoba menggunakan SF Pro Rounded, kemudian beralih ke font sistem jika tidak tersedia.",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'Blur latar belakang modal.',
    },
  ]}
/>
