...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      default: 'lengkap',
      type: '"avatar" | "alamat" | "lengkap" | { smallScreen: AccountStatus, largeScreen?: AccountStatus }',
      typeSimple: 'enum',
      description:
    ...
    },
    {
      name: 'chainStatus',
      required: false,
      default: '{ smallScreen: "ikon", largeScreen: "lengkap" }',
      type: '"ikon" | "nama" | "lengkap" | "none" | { smallScreen: ChainStatus, largeScreen?: ChainStatus }',
      typeSimple: 'enum',
      description:
