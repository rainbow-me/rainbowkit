...
Catatan: wagmi tidak lagi menggunakan paket `ethers` secara internal. Tetapi jika Anda mengandalkan API [Autentikasi](https://www.rainbowkit.com/docs/authentication), `siwe` masih memerlukan `ethers` sebagai dependensi sejawat.
