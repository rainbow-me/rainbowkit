...
Merujuk pada sampel [Konfigurasi Next.js](https://github.com/rainbow-me/rainbowkit/blob/main/examples/with-next/next.config.js) kami untuk panduan konfigurasi proyek Anda.
