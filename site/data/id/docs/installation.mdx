...
RainbowKit bekerja dengan [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (bundler default di Next.js 16+) serta [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).
