...
قم بتكوين السلاسل المطلوبة وتوليد الموصلات المطلوبة. سوف تحتاج أيضا إلى إعداد تكوين `wagmi`. If your dApp uses server side rendering (SSR) make sure to set `ssr` to `true`.
