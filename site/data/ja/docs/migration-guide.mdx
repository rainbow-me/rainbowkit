...
開発者は引き続きカスタムウォレットリストを完全に制御でき、エンドユーザーにとって優先されるウォレットを強調表示できます。 すべてのプラットフォームをサポートするために、`injectedWallet` と `walletConnectWallet` をリストに含め続けることをお勧めします。 `injectedWallet` と `walletConnectWallet` をリストに含め続けることを推奨します。これにより、すべてのプラットフォームをサポートできます。 `injectedWallet` と `walletConnectWallet` をリストに含め続けることを推奨します。これにより、すべてのプラットフォームをサポートできます。 すべてのプラットフォームをサポートするために、`injectedWallet` と `walletConnectWallet` をリストに含め続けることをお勧めします。
