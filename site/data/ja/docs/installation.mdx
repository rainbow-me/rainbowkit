...
RainbowKitは[Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) （Next.js 16+のデフォルトバンドラー）と[webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack)の両方で動作します。
