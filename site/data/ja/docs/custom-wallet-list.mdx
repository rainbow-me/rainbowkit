...
`preference`引数は、Smart Walletをユーザーにとって優先するか無効にするかを制御するために利用可能です。 `preference`引数は、Smart Walletをユーザーにとって優先するか無効にするかを制御するために利用可能です。 プリファレンスに基づく動作は、[こちら](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional)で文書化されています。
