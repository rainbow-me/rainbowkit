...
Dieser Wallet-Connector unterstützt sowohl die Coinbase Wallet-App und -Erweiterung als auch die Coinbase Smart Wallet im Web.

Ein `preference`-Argument steht zur Verfügung, um zu steuern, ob die Smart Wallet für Ihre Benutzer bevorzugt oder deaktiviert ist. Präferenzbasiertes Verhalten ist [hier](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional) dokumentiert.

Zusätzliche Konfigurationsoptionen zur Steuerung von [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) und [Sub-Accounts](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) finden Sie in der Coinbase Wallet SDK-Dokumentation [hier](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
...
Zeigen Sie Rainbow, MetaMask und Coinbase zusammen mit generischen Fallback-Wallets.
