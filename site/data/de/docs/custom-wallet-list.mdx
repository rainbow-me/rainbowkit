...
Ein `preference`-Argument ist verfügbar, um zu steuern, ob die Smart Wallet aktiviert und für die Nutzer verfügbar ist. Das Verhalten basierend auf den Präferenzen wird [hier](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional) dokumentiert.

Zusätzliche Konfigurationsoptionen zur Steuerung von [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) und [Sub Accounts](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) finden sich in den Coinbase Wallet SDK-Dokumenten [hier](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
