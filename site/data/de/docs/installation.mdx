...
RainbowKit funktioniert sowohl mit [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (dem Standard-Bundler in Next.js 16+) als auch mit [Webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).

Wenn Sie Plugins verwenden, die noch Webpack benötigen, fügen Sie das `--webpack`-Flag zu Ihren Scripts hinzu:
