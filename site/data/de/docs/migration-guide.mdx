...
Verweisen Sie auf unsere [Next.js Webpack-Konfiguration](https://github.com/rainbow-me/rainbowkit/blob/main/examples/with-next/next.config.js) Beispiele zur Konfiguration Ihres Projekts.
