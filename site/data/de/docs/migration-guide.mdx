...
Verweisen Sie auf unser [Next.js Config](https://github.com/rainbow-me/rainbowkit/blob/main/examples/with-next/next.config.js) Beispiel für Konfigurationshinweise für Ihr Projekt.
