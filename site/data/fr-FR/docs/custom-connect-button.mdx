...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: (
        <>
          Le solde du compte formaté en tant que chaîne de caractères, par exemple{' '}
    ...
    },
    {
      ...
      description: (
        <>
          Le symbole monétaire pour le solde, par exemple <code>ETH</code>
        </>
      ),
    },
    {
      ...
      description: (
        <>
          Le solde formaté avec 3 chiffres significatifs, plus le
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: (
        <>
          L'ID de la chaîne, par exemple <code>1</code>
        </>
      ),
    },
    {
