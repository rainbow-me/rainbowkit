...
Consulta nuestra [Configuración de Next.js](https://github.com/rainbow-me/rainbowkit/blob/main/examples/with-next/next.config.js) de muestra para obtener orientación de configuración para tu proyecto.
