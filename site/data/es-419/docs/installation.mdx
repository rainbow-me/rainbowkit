...
RainbowKit funciona tanto con [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (el empaquetador predeterminado en Next.js 16+) como con [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).
