...
Está disponible un argumento de `preference` para controlar si el Smart Wallet está habilitado y disponible para los usuarios. El comportamiento basado en preferencias está documentado [aquí](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

Opciones de configuración adicional para el control de [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) y [Sub Cuentas](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) se pueden encontrar en la documentación del SDK de Coinbase Wallet [aquí](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
