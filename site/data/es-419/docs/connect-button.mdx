  ...
  data={[
    {
      ...
      type: 'string',
      description: 'El texto de la etiqueta que se muestra en el botón Connect',
    },
    {
      name: 'accountStatus',
      required: false,
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description:
        "Si se muestra el ícono y/o el nombre de la cadena actual, o si está oculto por completo",
    },
    {
      name: 'showBalance',
      required: false,
