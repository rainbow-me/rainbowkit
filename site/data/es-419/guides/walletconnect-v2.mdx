...
Si tu dApp requiere soporte para una cartera legacy que aún no ha migrado a WalletConnect v2, la versión predeterminada de WalletConnect de RainbowKit se puede reemplazar para cada cartera de manera independiente.
...
Una vez que los servidores de WalletConnect v1 se apaguen el 28 de junio, se requiere un [servidor puente personalizado](https://docs.walletconnect.com/1.0/bridge-server) para continuar utilizando el protocolo v1. Consulta los siguientes ejemplos:
