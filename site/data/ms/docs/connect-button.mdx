...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      default: 'penuh',
      type: '"avatar" | "alamat" | "penuh" | { skrinKecil: StatusAkaun, skrinBesar?: StatusAkaun }',
      typeSimple: 'enum',
      description:
    ...
    },
    {
      name: 'statusRantaian',
      required: false,
      default: '{ skrinKecil: "ikon", skrinBesar: "penuh" }',
      type: '"ikon" | "nama" | "penuh" | "tiada" | { skrinKecil: StatusRantaian, skrinBesar?: StatusRantaian }',
      typeSimple: 'enum',
      description:
    ...
    },
    {
      name: 'paparBaki',
      required: false,
      default: '{ skrinKecil: false, skrinBesar: true }',
      type: 'boolean | { skrinKecil: boolean, skrinBesar?: boolean }',
      typeSimple: 'enum',
      description:
