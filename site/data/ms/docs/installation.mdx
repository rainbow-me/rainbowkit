...
RainbowKit berfungsi dengan kedua-duanya [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (penggabung lalai dalam Next.js 16+) dan [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).

Jika anda menggunakan plugin yang masih memerlukan Webpack, tambah bendera `--webpack` ke dalam skrip anda:
