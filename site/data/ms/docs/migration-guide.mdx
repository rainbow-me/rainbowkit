...
Rujuk kepada [Konfigurasi Webpack Next.js](https://github.com/rainbow-me/rainbowkit/blob/main/examples/with-next/next.config.js) kami sebagai panduan konfigurasi untuk projek anda.
