...
Rujuk sampel [Next.js Config](https://github.com/rainbow-me/rainbowkit/blob/main/examples/with-next/next.config.js) kami untuk panduan konfigurasi bagi projek anda.
