...
Penyambung dompet ini menyokong kedua-dua aplikasi dan sambungan Coinbase Wallet, serta Coinbase Smart Wallet di Web.

Argumen `preference` tersedia untuk mengawal sama ada Smart Wallet lebih diutamakan atau dilumpuhkan untuk pengguna anda. Tingkah laku berasaskan keutamaan didokumentasikan [di sini](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

Pilihan konfigurasi tambahan untuk kawalan [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) dan [Sub Accounts](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) boleh ditemukan dalam dokumen SDK Coinbase Wallet [di sini](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
...
Paparkan Rainbow, MetaMask dan Coinbase bersama dompet pemulihan generik.
...
Cadangkan Rainbow dan MetaMask, tetapi juga tawarkan Coinbase bersama dompet pemulihan generik.
