...
Ini adalah pilihan dompet gantian yang direka untuk scenario di mana `window.ethereum` wujud tetapi belum disediakan oleh dompet lain dalam senarai. Dompet ini akan menyembunyikan dirinya secara automatik dari senarai apabila gantian tidak diperlukan atau jika tiada dompet yang dimasukkan tersedia.
