...
Penyambung dompet RainbowKit telah mengalami perubahan ketara untuk menyokong Wagmi v2. Rujuk [dokumentasi yang dikemas kini](https://www.rainbowkit.com/docs/custom-wallets) dan [penyambung contoh](https://github.com/rainbow-me/rainbowkit/tree/main/packages/rainbowkit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) untuk menaik taraf mana-mana Penyambung Dompet Tersuai dalam dApp anda.
