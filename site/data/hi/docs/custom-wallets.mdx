...
> नोट: यह API अस्थिर है और निकट भविष्य में बदल सकती है। हम समय के साथ अधिक बिल्ट-इन वॉलेट्स जोड़ेंगे। यदि आपको किसी विशेष वॉलेट्स में रुचि है तो [हमें बताएं](https://github.com/rainbow-me/rainbowkit/issues)।

`वॉलेट` फ़ंक्शन प्रकार आपके अपने कस्टम वॉलेट्स को परिभाषित करने में आपकी सहायता करने के लिए प्रदान किया गया है। आपके `वॉलेट` फ़ंक्शन के रिटर्न मान पर निम्नलिखित गुण कॉन्फ़िगर किए जा सकते हैं:
