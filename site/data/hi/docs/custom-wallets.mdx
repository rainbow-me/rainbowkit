...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Function for calculating whether this wallet should be hidden from the list. यह जीनेरिक फॉलबैक वॉलेट को परिभाषित करने के लिए महत्वपूर्ण है, जैसे कि इस फ़ीचर का उपयोग "इन्जेक्टेड वॉलेट" फॉलबैक में किया जाता है',
    },
    {
      ...
      description:
        'विभिन्न कनेक्शन मेथड के लिए कनेक्टर इंस्टेंस और कॉन्फ़िगरेशन प्रदान करने के लिए फ़ंक्शन, नीचे वर्णित',
    },
  ]}
/>
...
### RainbowKitConnector गुण

निम्नलिखित गुण `createConnector` function की वापसी मूल्य पर परिभाषित किए गए हैं।
