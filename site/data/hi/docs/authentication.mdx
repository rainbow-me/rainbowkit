...
यदि आपने पहले से नहीं किया है, तो पहले अपने [Next.js](https://nextjs.org) प्रोजेक्ट को [NextAuth.js के लिए आधिकारिक Sign-In with Ethereum बॉयलरप्लेट](https://docs.login.xyz/integrations/nextauth.js) के साथ सेटअप करें।
