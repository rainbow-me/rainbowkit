...
`preference` तर्क उपलब्ध है, जो यह नियंत्रित करता है कि आपके उपयोगकर्ताओं के लिए स्मार्ट वॉलेट को प्राथमिकता दी जाए या अक्षम कर दिया जाए। यहाँ वरीयता आधारित व्यवहार को दस्तावेज़ित किया गया है [यहाँ](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

[पेमास्टर्स](https://docs.base.org/identity/smart-wallet/guides/paymasters) और [सब अकाउंट्स](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) के नियंत्रण के लिए अतिरिक्त कॉन्फ़िगरेशन विकल्प Coinbase Wallet SDK के दस्तावेज़ों में उपलब्ध हैं [यहाँ](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
