  ...
  data={[
    {
      ...
      type: 'string',
      description:
        'विभिन्न इंटरैक्टिव तत्वों के पृष्ठभूमि/पाठ का रंग।',
    },
    {
      ...
      type: 'string',
      description:
        'मुख्य रंग पर रेंडर किए गए अग्रभूमि तत्वों के लिए प्रयुक्त रंग।',
    },
    {
      name: 'borderRadius',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'संपूर्ण बॉर्डर त्रिज्या पैमाने का आकार।',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      typeSimple: 'enum',
      description:
        "UI में पूरे उपयोग के लिए फॉन्ट स्टैक।" ध्यान दें कि `rounded` SF Pro Rounded का उपयोग करने का प्रयास करता है, जब यह उपलब्ध नहीं होता है तो सिस्टम फॉन्ट्स की ओर लौटता है।",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'मॉडल बैकड्रॉप धुंधलापन।',
    },
  ]}
/>
