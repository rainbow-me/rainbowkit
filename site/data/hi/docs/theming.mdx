...
एक थीम फ़ंक्शन एक थीम ऑब्जेक्ट लौटाता है। आप इस ऑब्जेक्ट को `RainbowKitProvider` के `theme` प्रॉप में पास कर सकते हैं।
...
प्रत्येक थीम भी कई एक्सेंट रंग प्रीसेट ( `blue`, `green`, `orange`, `pink`, `purple`, `red`) प्रदान करती है जिन्हें विकल्प ऑब्जेक्ट में शामिल किया जा सकता है। उदाहरण के लिए, `pink` एक्सेंट रंग प्रीसेट का उपयोग करने के लिए:
...
डिफ़ॉल्ट रूप से, `fontStack` को `rounded` पर सेट किया गया है। लेकिन यहाँ यह बताया गया है कि आप `fontStack` config का उपयोग कैसे कर सकते हैं।
...
डिफ़ॉल्ट रूप से, `overlayBlur` को `none` पर सेट किया गया है। लेकिन यहाँ यह बताया गया है कि आप `overlayBlur` config का उपयोग कैसे कर सकते हैं।
