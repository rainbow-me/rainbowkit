...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description:
        "The font stack used throughout the UI. नोट के `राउंडेड` कुछ नहीं है SF Pro Rounded की गईका, और तऻरों नहीं है क्या अब्रेकल फॉन्ट सिसीम पर पूर्व बताने की ये वंस्वित कर रहा है.",
    },
    {
      name: 'overlayBlur',
      required: false,
