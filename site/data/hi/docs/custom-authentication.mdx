...
`createMessage` एक `Promise` वापस करने का भी समर्थन करता है, जिससे आप सर्वर पर [EIP-4361](https://eips.ethereum.org/EIPS/eip-4361) संदेश बना सकते हैं। अधिक सख्त सुरक्षा के लिए, सर्वर का एन्डपॉइंट सुरक्षा-आवश्यक क्षेत्रों जैसे `domain`, `nonce`, और `issued-at` समय संस्करण को ग्राहक प्रदान-मानों पर भरोसा करने के बजाय आयत या सत्यापित करना चाहिए। अधिक जानकारी के लिए [SIWE दस्तावेज़](https://docs.siwe.xyz/security-considerations#server-side-message-generation) देखें।
