...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      default: 'पूरा',
      type: '"अवतार" | "पता" | "पूरा" | { smallScreen: AccountStatus, largeScreen?: AccountStatus }',
      typeSimple: 'enum',
      description:
    ...
    },
    {
      name: 'चेन स्थिति',
      required: false,
      default: '{ smallScreen: "चिह्न", largeScreen: "पूरा" }',
      type: '"चिह्न" | "नाम" | "पूरा" | "कोई नहीं" | { smallScreen: ChainStatus, largeScreen?: ChainStatus }',
      typeSimple: 'enum',
      description:
