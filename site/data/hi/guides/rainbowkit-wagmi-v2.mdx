...
RainbowKit वॉलेट कनेक्टर्स ने Wagmi v2 का समर्थन करने के लिए पर्याप्त परिवर्तन किए हैं। अपने dApp में किसी भी कस्टम वॉलेट कनेक्टर्स को अपग्रेड करने के लिए [अपडेटेड डॉक्स](https://www.rainbowkit.com/docs/custom-wallets) और [उदाहरण कनेक्टर](packages/rainbowkit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) को देखें। अपने dApp में किसी भी कस्टम वॉलेट कनेक्टर को अपग्रेड करने के लिए [अपडेटेड दस्तावेज़](https://www.rainbowkit.com/docs/custom-wallets) और एक [उदाहरण कनेक्टर](https://github.com/rainbow-me/rainbowkit/tree/main/packages/rainbowkit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) को संदर्भित करें।
