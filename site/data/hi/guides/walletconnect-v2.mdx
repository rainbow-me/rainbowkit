...
यदि आपके dApp को किसी पुरानी वॉलेट का समर्थन करना आवश्यक है जो अभी तक WalletConnect v2 पर स्थानांतरित नहीं हुआ है, तो RainbowKit का डिफ़ॉल्ट WalletConnect संस्करण प्रत्येक वॉलेट के लिए स्वतंत्र रूप से ओवरराइड किया जा सकता है।
