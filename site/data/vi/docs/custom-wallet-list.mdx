...
Có một tham số `preference` để kiểm soát liệu Smart Wallet được ưu tiên hay bị vô hiệu hóa cho người dùng của bạn. Hành vi dựa trên sở thích được tài liệu [[ở đây]](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

Các tùy chọn cấu hình bổ sung để kiểm soát [[Paymasters]](https://docs.base.org/identity/smart-wallet/guides/paymasters) và [[Tài Khoản Phụ]](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) có thể được tìm thấy trong tài liệu Coinbase Wallet SDK [[ở đây]](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
