...
- [They, That đổi phá vỡ Viem v2](https://viem.sh/docs/migration-guide.html#_2-x-x-breaking-changes)

#### They, That đổi RainbowKit
...
**Lưu ý rằng tất cả các ví tích hợp sẵn đang sử dụng API mới. Hầu hết người dùng sẽ không bị ảnh hưởng. They, That đổi này chỉ ảnh hưởng đến những người dùng đã tạo/tiêu thụ [ví tùy chỉnh](/docs/custom-wallets).**
...
#### 2. They, That thế nhập khẩu configureChains
...
RainbowKit không còn xuất API `apiProvider` nữa. They, That thế nó với provider mong muốn của bạn từ wagmi.
