...
Mặc dù RainbowKit cung cấp [hỗ trợ hạng nhất cho Đăng nhập bằng Ethereum và NextAuth.js,](/docs/authentication#set-up-sign-in-with-ethereum-and-nextauthjs) bạn cũng có thể tích hợp với các hệ thống và định dạng tin nhắn tùy chỉnh.
...
Lấy ví dụ, chúng ta có thể tạo bộ điều hợp xác thực cho phép chúng ta sử dụng [Đăng nhập bằng Ethereum](https://login.xyz) với một số [điểm cuối API tùy chỉnh.](https://wagmi.sh/examples/sign-in-with-ethereum)
