...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      default: 'đầy đủ',
      type: '"hình đại diện" | "địa chỉ" | "đầy đủ" | { màn hình nhỏ: Trạng tháiTàiKhoản, màn hình lớn?: Trạng tháiTàiKhoản }',
      typeSimple: 'enum',
      description:
    ...
    },
    {
      name: 'chainStatus',
      required: false,
      default: '{ màn hình nhỏ: "biểu tượng", màn hình lớn: "đầy đủ" }',
      type: '"biểu tượng" | "tên" | "đầy đủ" | "không có" | { màn hình nhỏ: Trạng tháiChuỗi, màn hình lớn?: Trạng tháiChuỗi }',
      typeSimple: 'enum',
      description:
    ...
    },
    {
      name: 'showBalance',
      required: false,
      default: '{ màn hình nhỏ: false, màn hình lớn: true }',
      type: 'boolean | { màn hình nhỏ: boolean, màn hình lớn?: boolean }',
      typeSimple: 'enum',
      description:
