...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      default: 'bo tròn',
      type: '"bo tròn" | "hệ thống"',
      typeSimple: 'enum',
      description:
        "Kiểu chữ sử dụng trong toàn bộ giao diện. Lưu ý rằng `bo tròn` cố gắng sử dụng SF Pro Rounded, tự động chuyển sang font hệ thống khi không có sẵn.",
    },
    {
      name: 'overlayBlur',
      required: false,
      default: 'không có',
      type: '"lớn" | "nhỏ" | "không có"',
      typeSimple: 'enum',
