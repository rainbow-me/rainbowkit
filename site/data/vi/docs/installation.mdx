...
RainbowKit hoạt động với cả [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (gói mặc định trong Next.js 16+) và [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).

Nếu bạn đang sử dụng các plugin vẫn yêu cầu Webpack, hãy thêm cờ `--webpack` vào script của bạn:
