...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'string',
      description:
        '강조 색상 위에 렌더링된 전경 요소에 사용되는 색상입니다.',
    },
    {
      name: 'borderRadius',
      required: false,
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description:
        "UI 전체에 사용되는 폰트 스택입니다." `rounded`는 SF Pro Rounded를 사용하려고 시도하며, 사용할 수 없을 때는 시스템 폰트로 대체합니다.",
    },
    {
      name: 'overlayBlur',
      required: false,
