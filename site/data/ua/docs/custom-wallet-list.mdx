...
Доступний аргумент `preference`, що дозволяє керувати тим, чи буде Smart Wallet надано перевагу або відключено для ваших користувачів. Поведінка на основі переваг задокументована [тут](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).
