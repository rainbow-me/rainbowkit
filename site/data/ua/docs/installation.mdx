...
RainbowKit працює як із [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (стандартний завантажувач у Next.js 16+), так і з [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).
