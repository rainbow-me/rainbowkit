...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description:
        "The font stack used throughout the UI. Зверніть увагу, що `rounded` намагається використовувати SF Pro Rounded, повертаючись до системних шрифтів, якщо він недоступний.",
    },
    {
      name: 'overlayBlur',
      required: false,
