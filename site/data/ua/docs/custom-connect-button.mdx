...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: (
        <>
          ID ланцюга, наприклад, <code>1</code>
        </>
      ),
    },
    {
      ...
      description: (
        <>
          Назва ланцюга, наприклад, <code>"Ethereum"</code>
        </>
      ),
    },
    {
      ...
      description:
        'Булеве значення, яке вказує, чи є поточний ланцюг не підтримуваним',
    },
  ]}
/>
  ...
  data={[
    {
      ...
      required: false,
      type: '() => void',
      description: 'Функція для відкриття модального вікна облікового запису',
    },
    {
      name: 'openChainModal',
      required: false,
    ...
    },
    {
      ...
      type: 'boolean',
      description:
        'Булеве значення, яке вказує, чи відкрито модальне вікно облікового запису',
    },
    {
      name: 'chainModalOpen',
      required: false,
      type: 'boolean',
      description: 'Булеве значення, яке вказує, чи відкрито модальне вікно ланцюга',
    },
    {
      ...
      type: 'boolean',
      description:
        'Булеве значення, яке вказує, чи відкрито модальне вікно підключення',
    },
  ]}
/>
