...
Конектори гаманців RainbowKit зазнали значних змін для підтримки Wagmi v2. Перегляньте [оновлені документи](https://www.rainbowkit.com/docs/custom-wallets) та [приклад підключення](https://github.com/rainbow-me/rainbowkit/tree/main/packages/rainbowkit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts), щоб оновити будь-які користувацькі підключення гаманця у вашому dApp.
