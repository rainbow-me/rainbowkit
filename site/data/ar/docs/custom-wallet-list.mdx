...
يتوفر برهان `preference` للتحكم فيما إذا كانت محفظة Smart Wallet مفعّلة أو معطلة للمستخدمين. تم توثيق السلوك القائم على البرهان [هنا](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

يمكن العثور على خيارات تهيئة إضافية للتحكم في [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) و[الحسابات الفرعية](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) في مستندات SDK لمحفظة Coinbase [هنا](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
