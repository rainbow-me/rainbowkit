...
يتوفر وسيط تفضيل للسيطرة على تفعيل محفظة Smart Wallet أو تعطيلها للمستخدمين لديك. سلوك التفضيل موثق [هنا](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional).

يمكن العثور على خيارات تكوين إضافية للسيطرة على [Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) و [Sub Accounts](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) في وثائق محفظة Coinbase SDK [هنا](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters).
