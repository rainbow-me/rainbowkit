...
يعمل RainbowKit مع كل من [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (الحزمة الضامة الافتراضية في Next.js 16+) و[ويب باك](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).

إذا كنت تستخدم الإضافات التي لا تزال تتطلب Webpack، قم بإضافة علامة `--webpack` إلى تعليماتك البرمجية:
