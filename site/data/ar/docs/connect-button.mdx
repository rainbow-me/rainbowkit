...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      default: 'كامل',
      type: '"صورة رمزية" | "العنوان" | "كامل" | { شاشة صغيرة: AccountStatus, شاشة كبيرة؟: AccountStatus }',
      typeSimple: 'enum',
      description:
    ...
    },
    {
      name: 'chainStatus',
      required: false,
      default: '{ شاشة صغيرة: "أيقونة", شاشة كبيرة: "كامل" }',
      type: '"أيقونة" | "اسم" | "كامل" | "لا أحد" | { شاشة صغيرة: ChainStatus, شاشة كبيرة؟: ChainStatus }',
      typeSimple: 'enum',
      description:
    ...
    },
    {
      name: 'showBalance',
      required: false,
      default: '{ شاشة صغيرة: false, شاشة كبيرة: true }',
      type: 'boolean | { شاشة صغيرة: boolean, شاشة كبيرة؟: boolean }',
      typeSimple: 'enum',
      description:
