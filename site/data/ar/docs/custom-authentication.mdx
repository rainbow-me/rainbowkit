...
بينما يقدم RainbowKit [دعمًا من الدرجة الأولى لتسجيل الدخول باستخدام Ethereum وNextAuth.js،](/docs/authentication#set-up-sign-in-with-ethereum-and-nextauthjs) يمكنك أيضًا الدمج مع الخلفيات المخصصة وتنسيقات الرسائل.
