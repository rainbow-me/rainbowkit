...
<PropsTable
  data={[
    {
      name: 'لون الظل الملفت للنظر',
      required: false,
      default: '"#0E76FD"',
      type: 'سلسلة',
      description:
        'لون الخلفية/النص لعناصر التفاعل المختلفة.',
    },
    {
      name: 'لون النص للظل الملفت للنظر',
      required: false,
      default: '"أبيض"',
      type: 'سلسلة',
      description:
        'اللون المستخدم لعناصر النص المظهرة أعلى الظل الملفت للنظر.',
    },
    {
      name: 'نصوص الزوايا',
      required: false,
      default: 'كبير',
      type: '"لا شيء" | "صغير" | "متوسط" | "كبير"',
      typeSimple: 'تعداد',
      description: 'حجم مقياس نصوص الزوايا بأكمله.',
    },
    {
      name: 'علامة التبويب الخطية',
      required: false,
      default: 'مستديرة',
      type: '"مستديرة" | "النظام"',
      typeSimple: 'تعداد',
      description:
        "الحزمة الخطية المستخدمة في جميع واجهة المستخدم. ملاحظة أن `rounded` يحاول استخدام خطوط SF Pro Rounded، وعندما لا تكون متاحة، يستخدم خطوط النظام.",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'إضاءة خلفية المودال.',
    },
  ]}
/>
