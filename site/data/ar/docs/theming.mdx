  ...
  data={[
    {
      ...
      type: 'string',
      description:
        'لون خلفية/نص العناصر التفاعلية المختلفة.',
    },
    {
      ...
      type: 'string',
      description:
        'اللون المستخدم لعناصر المقدمة التي يتم تقديمها فوق لون التمييز.',
    },
    {
      name: 'borderRadius',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'حجم نصف قطر الحدود الكلي.',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      typeSimple: 'enum',
      description:
        "مجموعة الخطوط المستخدمة في جميع أنحاء واجهة المستخدم.", <span class="notranslate">33</span>     }, <span class="notranslate">34</span>     { <span class="notranslate">35</span>       name: 'overlayBlur', <span class="notranslate">36</span>       required: false, <span class="notranslate">37</span>       default: 'none', <span class="notranslate">38</span>       type: '"large" | "small" | "none"', <span class="notranslate">39</span>       typeSimple: 'enum', <span class="notranslate">40</span>       description: 'طمس خلفية النافذة المنبثقة.', <span class="notranslate">41</span>     }, <span class="notranslate">42</span>   ]} <span class="notranslate">43</span> /> Note that `rounded` attempts to use SF Pro Rounded, falling back to system fonts when it isn't available.",
    },
    {
      name: 'overlayBlur',
      required: false,
