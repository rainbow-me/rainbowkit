...
ملاحظة: لم يعد wagmi يستخدم حزمة `ethers` داخلياً. ولكن إذا كنت تعتمد على [واجهة برمجة التطبيقات للمصادقة](https://www.rainbowkit.com/docs/authentication)، سيظل `siwe` يتطلب `ethers` كاعتماد نظير.
