...
إذا كان تطبيقك اللامركزي يتطلب دعم محفظة قديمة لم تتم ترقيتها بعد إلى WalletConnect الإصدار الثاني، فيمكن تجاوز إصدار WalletConnect الافتراضي لكل محفظة على حدة في RainbowKit.
