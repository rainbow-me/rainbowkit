...
كل dApp يعتمد على WalletConnect يحتاج الآن إلى الحصول على `projectId` من [WalletConnect Cloud](https://cloud.walletconnect.com/). هذا مجاني تماما ويستغرق فقط بضع دقائق.
...
إذا كان تطبيق dApp الخاص بك يتطلب دعم محفظة قديمة لم تنتقل بعد إلى WalletConnect v2، يمكن تجاوز إصدار WalletConnect الافتراضي في RainbowKit لكل محفظة بشكل مستقل.
...
بمجرد إيقاف خوادم WalletConnect v1 في 28 يونيو، سيكون مطلوبًا [custom bridge server] \(https://docs.walletconnect.com/1.0/bridge-server) لمواصلة استخدام بروتوكول v1. راجع الأمثلة التالية:
