...
RainbowKit 是类型安全的，当 `projectId` 缺失时，它会警告你。 请参考我们的示例来查看 v2 的操作过程：
...
一旦WalletConnect v1服务器在6月28日停用，需要[自定义桥接服务器](https://docs.walletconnect.com/1.0/bridge-server)以继续使用v1协议。 参考以下示例：
