...
在v2中，您的用户现在可以同时连接到多个链，因此您可以忘记关于切换链的握手操作。 它还扩大了对更多网络的支持，并带来了使以太坊登陆更快的改进。 它还扩大了对更多网络的支持，并带来了使以太坊登陆更快的改进。
...
一旦WalletConnect v1服务器在6月28日停用，需要[自定义桥接服务器](https://docs.walletconnect.com/1.0/bridge-server)以继续使用v1协议。 参考以下示例： 参考以下示例：
