...
RainbowKit 兼容 [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack)（Next.js 16+的默认打包器）和 [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack)。

如果您正在使用仍需 Webpack 的插件，请在脚本中添加 `--webpack` 标志：
