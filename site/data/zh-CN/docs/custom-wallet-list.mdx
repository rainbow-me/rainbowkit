...
为了迁移到 WalletConnect v2，Web3Modal v2 的 `options` 也受到支持。 参考[Ethereum Provider 文档](https://docs.walletconnect.com/2.0/javascript/providers/ethereum#initialization)。 所需的 `projectId` 会由 RainbowKit 自动预填充。
