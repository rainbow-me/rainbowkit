...
提供了一个`preference`参数，用于控制是否为用户启用和提供智能钱包。 提供了一个`preference`参数，用于控制是否为用户启用和提供智能钱包。 基于偏好的行为记录于[此处](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional)。
