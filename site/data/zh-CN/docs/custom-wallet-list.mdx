...
此钱包连接器支持 Coinbase Wallet 应用和扩展程序，也支持在 Web 上的 Coinbase Smart Wallet。

提供了 `preference` 参数，可以控制用户是否偏好或禁用 Smart Wallet。基于偏好的行为记录在[这里](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional)。

[支付主](https://docs.base.org/identity/smart-wallet/guides/paymasters)和[子账户](https://docs.base.org/identity/smart-wallet/guides/sub-accounts)的控制附加配置选项可在Coinbase Wallet SDK文档中找到[这里](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters)。
