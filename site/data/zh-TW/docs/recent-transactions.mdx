...
您可以選擇在RainbowKit的帳戶選項中顯示最近的交易。 請注意，所有交易都保存在本地存儲中，必須手動註冊到RainbowKit才能顯示。 您可以選擇在RainbowKit的帳戶選項中顯示最近的交易。 請注意，所有交易都保存在本地存儲中，必須手動註冊到RainbowKit才能顯示。 請注意，所有交易都保存在本地存儲中，必須手動註冊到RainbowKit才能顯示。
