...
RainbowKit 兼容 [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack)（Next.js 16+ 的默認打包器）和 [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack)。

如果您使用的插件仍然需要 Webpack，請在您的腳本中添加 `--webpack` 標誌：
