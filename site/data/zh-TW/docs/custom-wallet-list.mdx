...
可用 `preference` 參數控制是否偏好或禁用用戶的 Smart Wallet。偏好行為在此處記錄 [here](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional)。

有關控制 [付款者](https://docs.base.org/identity/smart-wallet/guides/paymasters) 和 [子帳戶](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) 的其他配置選項，請參見 Coinbase Wallet SDK 文件的此處 [here](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters)。
