...
RainbowKit 錢包連接器已經過重大變更以支援 Wagmi v2。 RainbowKit 錢包連接器已經過重大變更以支援 Wagmi v2。 參考[更新的文件](https://www.rainbowkit.com/docs/custom-wallets)和一個[範例連接器](packages/rainbowkit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts)來升級您在 dApp 中的任何自定義錢包連接器。 RainbowKit 錢包連接器已經過重大變更以支持 Wagmi v2。 參考[更新的文件](https://www.rainbowkit.com/docs/custom-wallets)和一個[範例連接器](https://github.com/rainbow-me/rainbowkit/tree/main/packages/rainbowkit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts)來升級您在 dApp 中的任何自定義錢包連接器。
