...
Eğer dApp'iniz henüz WalletConnect v2'ye geçmemiş eski bir cüzdanı desteklemeyi gerektiriyorsa, RainbowKit'in varsayılan WalletConnect sürümü her cüzdan için bağımsız olarak geçersiz kılınabilir.
