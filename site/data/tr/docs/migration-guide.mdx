...
Projeleriniz için yapılandırma kılavuzu olarak bizim [Next.js Config](https://github.com/rainbow-me/rainbowkit/blob/main/examples/with-next/next.config.js) örneğine bakın.
