...
RainbowKit hem [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (Next.js 16+'da varsayılan paketleyici) hem de [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack) ile çalışır.
