...
Akıllı Cüzdan'ın etkin olup kullanıcılar için kullanılabilirliğini kontrol etmek amacıyla bir `preference` argümanı mevcuttur. Tercih tabanlı davranış [burada](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional) belgelenmiştir.
