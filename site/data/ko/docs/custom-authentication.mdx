...
RainbowKit은 [Ethereum 및 NextAuth.js로의 로그인에 대한 first-class 지원을 제공하는 반면,](/docs/authentication#set-up-sign-in-with-ethereum-and-nextauthjs) 사용자 정의 백엔드 및 메시지 형식과도 통합할 수 있습니다.
