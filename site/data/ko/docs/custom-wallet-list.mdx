...
`preference` 인수는 Smart Wallet의 활성화 및 사용 가능성을 제어할 수 있습니다. 환경설정 기반 동작은 [여기](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional)에서 문서화되어 있습니다.

[Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters) 및 [Sub Accounts](https://docs.base.org/identity/smart-wallet/guides/sub-accounts)를 제어할 수 있는 추가 설정 옵션은 [여기](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters) 있는 Coinbase Wallet SDK 문서에서 찾을 수 있습니다.
