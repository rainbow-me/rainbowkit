...
이 지갑 커넥터는 Coinbase Wallet 앱과 확장 프로그램, 그리고 웹에서 Coinbase 스마트 지갑을 지원합니다.

사용자의 스마트 지갑 사용 여부를 제어할 수 있는 `preference` 인수를 사용할 수 있습니다. 선호도 기반 행동은 [여기](https://docs.base.org/identity/smart-wallet/technical-reference/sdk/#options-optional)에 문서화되어 있습니다.

[Paymasters](https://docs.base.org/identity/smart-wallet/guides/paymasters)와 [Sub Accounts](https://docs.base.org/identity/smart-wallet/guides/sub-accounts) 제어를 위한 추가 설정 옵션은 Coinbase Wallet SDK 문서에서 [여기](https://docs.base.org/identity/smart-wallet/technical-reference/sdk#parameters)에서 찾을 수 있습니다.
...
일반 보조 지갑과 함께 Rainbow, MetaMask 및 Coinbase를 표시합니다.
...
Rainbow와 MetaMask를 추천하되, 일반 보조 지갑과 함께 Coinbase도 제공하십시오.
