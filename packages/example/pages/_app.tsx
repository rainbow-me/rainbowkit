...
function RainbowKitApp({
  ...
  useEffect(() => {
    // You should call `refreshConnectors` once you update your locale other than `en-US`
    // so connectors can be updated right after, but in this example
    // it's ok to call it right after page load
    refreshConnectors();
  }, [locale]);
