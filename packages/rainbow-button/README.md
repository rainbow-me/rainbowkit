...
Create an instance of the `RainbowConnector` and provide it in your wagmi config `connectors` list. Supply your `chains` list and your WalletConnect `projectId`. You can obtain a `projectId` from [Reown Cloud](https://cloud.reown.com/sign-in). This is absolutely free and only takes a few minutes.
