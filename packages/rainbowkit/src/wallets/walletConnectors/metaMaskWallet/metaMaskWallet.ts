...
export const metaMaskWallet = ({
  ...
  const shouldUseQRCode = !isMetaMaskInjected;
  ...
  return {
    ...
    iconAccent: '#f6851a',
    iconBackground: '#fff',
    installed: !shouldUseQRCode ? isMetaMaskInjected : undefined,
    downloadUrls: {
    ...
    mobile: {
      getUri: shouldUseQRCode ? getUri : undefined,
    },
    qrCode: shouldUseQRCode
      ? {
          getUri,
          instructions: {
