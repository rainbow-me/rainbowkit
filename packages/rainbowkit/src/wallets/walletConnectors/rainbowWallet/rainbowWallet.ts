                ...
                steps: [
                  {
                    ...
                    step: "install",
                    title: "wallet_connectors.extension.rainbow.step1.title",
                  },
                  {
                    description:
                      "wallet_connectors.extension.rainbow.step2.description",
                    step: "create",
                    title: "wallet_connectors.extension.rainbow.step2.title",
                  },
                  {
                    description:
                      "wallet_connectors.extension.rainbow.step3.description",
                    step: "scan",
                    title: "wallet_connectors.extension.rainbow.step3.title",
                  },
                ],
              },
            }
