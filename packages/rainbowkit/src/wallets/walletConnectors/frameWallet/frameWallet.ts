  ...
  createConnector: () => ({
    ...
    extension: {
      instructions: {
        ...
        steps: [
          {
            description: 'wallet_connectors.extension.frame.step1.description',
            step: 'install',
            title: 'wallet_connectors.extension.frame.step1.title',
          },
          {
            description: 'wallet_connectors.extension.frame.step2.description',
            step: 'create',
            title: 'wallet_connectors.extension.frame.step2.title',
          },
          {
            description: 'wallet_connectors.extension.frame.step3.description',
            step: 'refresh',
            title: 'wallet_connectors.extension.frame.step3.title',
          },
        ],
      },
    },
