                ...
                steps: [
                  {
                    ...
                    step: "install",
                    title: "wallet_connectors.qr_code.bifrost.step1.title",
                  },
                  {
                    description:
                      "wallet_connectors.qr_code.bifrost.step2.description",
                    step: "create",
                    title: "wallet_connectors.qr_code.bifrost.step2.title",
                  },
                  {
                    description:
                      "wallet_connectors.qr_code.bifrost.step3.description",
                    step: "scan",
                    title: "wallet_connectors.qr_code.bifrost.step3.title",
                  },
                ],
              },
            }
