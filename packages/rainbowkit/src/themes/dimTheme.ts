...
export const dimTheme = createTheme({
  ...baseTheme,
  colors: {
    connectButtonBackground: 'linear-gradient(179.83deg, rgba(26, 27, 31, 0.9) 0.15%, #1A1B1F 99.85%)',
    connectButtonText: 'white',
    connectionIndicator: '#30E000',
    dropdownButtonBackground: 'linear-gradient(179.83deg, rgba(26, 27, 31, 0.9) 0.15%, #1A1B1F 99.85%)',
