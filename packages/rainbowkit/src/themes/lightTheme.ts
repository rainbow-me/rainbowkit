...
export const lightTheme = createTheme({
  ...baseTheme,
  colors: {
    connectButtonBackground: 'linear-gradient(176.73deg, #FFFFFF 2.7%, rgba(255, 255, 255, 0.9) 97.31%)',
    connectButtonText: '#25292E',
    connectionIndicator: '#2CCC00',
    dropdownButtonBackground: 'linear-gradient(176.73deg, #FFFFFF 2.7%, rgba(255, 255, 255, 0.9) 97.31%)',
