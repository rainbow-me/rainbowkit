...
export { createAuthenticator } from './components/RainbowKitProvider/AuthenticationContext';
...
export type { Authenticator } from './components/RainbowKitProvider/AuthenticationContext';
