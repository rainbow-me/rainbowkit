...
import { DisableRecentWalletsContext } from './DisableRecentWalletsContext';
  ...
  return (
    <RainbowKitChainProvider chains={chains} initialChain={initialChain}>
      <CoolModeContext.Provider value={coolMode}>
        ...
        >
          <DisableRecentWalletsContext.Provider value={disableRecentWallets}>
          ...
          </DisableRecentWalletsContext.Provider>
        </ModalSizeContext.Provider>
