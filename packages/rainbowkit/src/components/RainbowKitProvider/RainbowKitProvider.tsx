...
export interface RainbowKitProviderProps {
  ...
  avatarFallback?: AvatarFallbackTheme;
...
export function RainbowKitProvider({
  ...
  const avatarFallbackContext = avatarFallback ?? 'emojis';
        ...
        >
          ...
          >
            <TransactionStoreProvider>
              <AvatarFallbackContext.Provider value={avatarFallbackContext}>
              ...
              </AvatarFallbackContext.Provider>
            </TransactionStoreProvider>
          </ShowRecentTransactionsContext.Provider>
        </ModalSizeContext.Provider>
