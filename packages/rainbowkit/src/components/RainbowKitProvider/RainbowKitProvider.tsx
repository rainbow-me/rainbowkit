...
const OpenConnectModalContext = createContext<() => void>(() => null);

export const useOpenConnectModal = () => useContext(OpenConnectModalContext);
              ...
              <AppContext.Provider value={appContext}>
                <ThemeIdContext.Provider value={id}>
                  <ConnectButton.Custom>
                    {({ openConnectModal }) => (
                      <OpenConnectModalContext.Provider
                        value={openConnectModal}
                      >
                        {theme ? (
